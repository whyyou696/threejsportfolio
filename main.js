...
let projects = [
  {
    image: 'textures/p1.png',
    url: 'https://winspo-e6d8c.web.app/',
  },
  {
  ...
  },
  {
    ...
    url: 'https://telang-realtime-api.web.app/',
  },
  {
    image: 'textures/p4.png',
    url: 'https://expo.dev/accounts/whyyou696/projects/client/updates/45d31701-dc83-4092-b272-1dc39d69381c',
  }
...
function loadIntroText() {
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const titleGeo = new TextGeometry('WAHYU RAMADHAN', {
      font: font,
      size: 0.06,
      height: 0.03,
    })
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      '*Switch the light buttons to turn into light or dark mode',
      {
        font: font,
        size: 0.017,
        height: 0,
